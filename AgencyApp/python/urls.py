...
urlpatterns = [
    ...
    url(r'^ajax/deleteProfileMediaPicture/$', ajax.deleteProfileMediaPicture, name='deleteProfileMediaPicture'),
    url(r'^ajax/updateProfileMediaPictureFeaturedStatus/$', ajax.updateProfileMediaPictureFeaturedStatus, name='updateProfileMediaPictureFeaturedStatus'),
    ...
    url(r'^ajax/submitNewApplication/$', ajax.submitNewApplication, name='submitNewApplication'),
